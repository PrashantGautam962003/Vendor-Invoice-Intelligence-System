...
if selected_model == "Freight Cost Prediction":
    ...
    **Objective:**
    ...
    with st.form("freight_form"):
        ...
        # FIXED: Moved inside the "with st.form("freight_form"):" block
...
# -----------------------------------------------------------------------------
    ...
    **Objective:**
    ...
    with st.form("invoice_flag_form"):
        ...
        # FIXED: Indented all columns and fields inside the "with st.form" block
        with col2:
        ...
        # FIXED: Moved inside the "with st.form("invoice_flag_form"):" block
    ...
    if submit_flag:
        ...
        if is_flagged:
            ...
            st.success("✅ Invoice passes **Auto-Approval**")